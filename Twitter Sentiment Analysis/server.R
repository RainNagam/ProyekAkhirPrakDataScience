...
shinyServer(function(input, output, session) {
  consumer_api_key <- "kN10uZhvt68Yv4WCbcW3ASgEG" 
  consumer_api_secret <- "O7pgIB0bDL4OWTcoNP6s5x5onM7oXHBhe7hlkYkiLfpX0H7QA5" 
  access_token <- "1474967528044564481-GyWvUQLgJPRZ3cfhldSBSNOdrlaoMV" 
  access_token_secret <- "qgpvZ0PVbxg3eoM204ez3zOGeLFcJ1VOk9MDKlUxFPvDt" 
